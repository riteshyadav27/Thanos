...
document.getElementById("login").addEventListener("click", function () {
    ...
    signInWithEmailAndPassword(auth, email, password)
        .then((userCredential) => {
            ...
            // TODO: set user location to where he/she has progressed upto
            if (rounds === 1) window.location.href = "../HTML/round1.html";
            else if (rounds === 2) window.location.href = "../HTML/round2.html";
            else if (rounds === 3) window.location.href = "../HTML/round3.html";
            else if (rounds === 4) window.location.href = "../HTML/round4.html";
            else if (rounds === 5) window.location.href = "../HTML/round5.html";
            else if (rounds === 6) window.location.href = "../HTML/round6.html";
            else window.location.href = "../HTML/getstarted.html";
            showSession()
        })
        .catch((error) => {
